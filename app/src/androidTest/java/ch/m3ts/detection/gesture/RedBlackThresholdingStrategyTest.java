...
@LargeTest
public class RedBlackThresholdingStrategyTest {
    private RedBlackThresholdingStrategy gestureDetectionStrategy;
    ...
    @Before
    public void setUp() {
        gestureDetectionStrategy = new RedBlackThresholdingStrategy();
        loadPicturesToMats();
    }
