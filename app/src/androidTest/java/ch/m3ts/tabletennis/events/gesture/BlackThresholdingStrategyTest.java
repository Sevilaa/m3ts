...
@LargeTest
public class BlackThresholdingStrategyTest {
    private BlackThresholdingStrategy gestureDetectionStrategy;
    ...
    @Before
    public void setUp() {
        gestureDetectionStrategy = new BlackThresholdingStrategy();
        loadPicturesToMats();
    }
