...
@LargeTest
public class LiveDebugActivityTest {
    private LiveDebugActivity liveDebugActivity;
    ...
    @Rule
    public ActivityTestRule<LiveDebugActivity> recordingActivityActivityTestRule = new ActivityTestRule<LiveDebugActivity>(LiveDebugActivity.class) {
        @Override
