package ch.m3ts.detection.audio;
 ...
 */
public class AudioBounceDetection implements com.google.audio.core.Callback {
    ...
    public AudioBounceDetection(AudioBounceDetection.Callback callback) {
