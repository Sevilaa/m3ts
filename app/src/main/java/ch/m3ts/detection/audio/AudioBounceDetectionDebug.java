 ...
 */
public class AudioBounceDetectionDebug implements com.google.audio.core.Callback {
    ...
    public AudioBounceDetectionDebug(TextView txtFrequency, TextView txtAudioBounce) {
