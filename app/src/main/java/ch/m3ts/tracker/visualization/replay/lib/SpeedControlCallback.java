    ...
    public void preRender(long presentationTimeUsec) {
        ...
        if (mPrevMonoUsec == 0) {
            ...
            if (frameDelta < 0) {
                ...
                Log.i("Warning: current frame and previous frame had same timestamp");
                ...
                Log.i("Inter-frame pause was " + (frameDelta / ONE_MILLION) +
            ...
            while (nowUsec < (desiredUsec - 100) /*&& mState == RUNNING*/) {
                ...
                try {
                    if (CHECK_SLEEP_TIME) {
                        ...
                        Log.d("sleep=" + sleepTimeUsec + " actual=" + (actualSleepNsec / 1000) +
