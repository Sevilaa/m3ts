...
import ch.m3ts.detection.trackselection.SameXYDirectionTrackSelection;
import cz.fmo.Lib;
...
public class SameXYDirectionTrackSelectionTest {
    private SameXYDirectionTrackSelection trackSelection;
    private List<Track> mockedTracks;

    @Before
    public void init() {
        trackSelection = new SameXYDirectionTrackSelection();
    ...
    public void selectTrack() {
        Track selectedTrack = trackSelection.selectTrack(mockedTracks, -1, 1, 0, 0);
        assertEquals(mockedTracks.get(1), selectedTrack);
        selectedTrack = trackSelection.selectTrack(mockedTracks, 1, 1, 0, 0);
